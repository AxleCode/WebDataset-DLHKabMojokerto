<?php 
  ...
  $datasekretariat = mysqli_query($koneksi, "SELECT * FROM dataset WHERE id_dataset ='6'");
...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Persampahan Admin - Dinas Lingkungan Hidup Kab Mojokerto</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <meta content="" name="keywords" />
    <meta content="" name="description" />

    <!-- Favicon -->
    <link href="img/<?php echo $lsa->nama_files ?>" rel="icon" />
  ...
  >
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav mx-auto bg-light rounded pe-4 py-3 py-lg-0">
        ...
        <a href="persampahanadmin.php" class="nav-item nav-link active">Pengaturan Data</a>
        <a href="persampahanlogo.php" class="nav-item nav-link">Pengaturan Logo</a>
        <a href="persampahanakun.php" class="nav-item nav-link">Pengaturan Akun</a>
      ...
      <div class="container">
        <div class="text-center mx-auto" style="max-width: 1000px">
          <h1 class="display-6 mb-3">
            Dataset Bidang Persampahan<br>DLH Kab Mojokerto
          </h1>
        </div>

        <div class="container mt-3 text-left p-5">
            <a href="persampahantambahdata.php"><button class="btn btn-success py-2 px-4 " type="submit">
            <img src="img/add-folder.png" width="20px" alt=""> &nbsp;Tambah Data
              </button> 
            </a>      
                  ...
                  <?php
                   ...
                   ?>  
                      ...
                      <?php
                        ...
                        while($data=mysqli_fetch_array($datasekretariat)){
                          ?>
                          <tr>
                            <td><?php echo $data['nama_dataset'] ?></td>
                            <td class="text-center"><?php echo $data['format_dataset']?></td>
                            <td class="text-center"> <a href="<?php echo $data['linkedit'] ?>" target="_blank"><img src="img/google-docs.png" alt="Dataset" width="20px" ></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                     <a href="editpersampahan.php?id=<?php echo $data['id'] ?>" ><img src="img/edit.png" alt="Dataset" width="20px" ></a>&nbsp;&nbsp;&nbsp;
                                                     <a href="hapusdataset.php?iddatasetpersampahan=<?php echo $data['id'] ?>" onclick="return confirm('Yakin Ingin Hapus?')">
                                                        <img src="img/delete.png" alt="hapus" width="20px" ></a>
                          </td>
                          </tr>
                          <?php
                        }
