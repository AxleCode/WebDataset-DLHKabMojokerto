      ...
      <div class="container">
        <div class="text-center mx-auto" style="max-width: 1000px">
          <h1 class="display-6 mb-3">
            Dataset UPDT Laboratorium<br>DLH Kab Mojokerto
          </h1>
        </div>

        <div class="container mt-3 text-left p-5">
            <a href="labtambahdata.php"><button class="btn btn-success py-2 px-4 " type="submit">
                        ...
                        while($data=mysqli_fetch_array($datasekretariat)){
                          ...
                          <tr>
                            ...
                            <td class="text-center"> <a href="<?php echo $data['linkedit'] ?>" target="_blank"><img src="img/google-docs.png" alt="Dataset" width="20px" ></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                     <a href="editlab.php?id=<?php echo $data['id'] ?>" ><img src="img/edit.png" alt="Dataset" width="20px" ></a>&nbsp;&nbsp;&nbsp;
                                                     <a href="hapusdataset.php?iddatasetlab=<?php echo $data['id'] ?>" onclick="return confirm('Yakin Ingin Hapus?')">
