    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav mx-auto bg-light rounded pe-4 py-3 py-lg-0">
        ...
        <div class="nav-item dropdown">
          ...
          <div class="dropdown-menu bg-light border-0 m-0">
            <a href="panduanpublic.php" target="blank" class="dropdown-item active">Panduan Lihat Data</a>
      ...
      <div class="container">
        <div class="text-center mx-auto" style="max-width: 1000px">
          <h1 class="display-6 mb-3">
            Panduan Melihat Dataset<br>DLH Kab Mojokerto
          </h1>
        </div>
        ...
        <div class="container mt-3 text-left p-5">       
            ...
            <p>6. Klik Bagian Bawah Untuk Melihat Page Yang Ada Pada Dokumen Dataset Tersebut </p>
            <p class="text-center"><img src="img/panduanpublic4.png" width="850px" ></p>
            <p class="text-center"><img src="img/panduanpublic5.png" width="850px" ></p>
            <p>6. Klik Bagian Bawah Untuk Scroll Page Dokumen Dataset Tersebut </p>
            <p class="text-center"><img src="img/panduanpublic6.png" width="850px" ></p>
            <p class="text-center"><img src="img/panduanpublic7.png" width="850px" ></p>
