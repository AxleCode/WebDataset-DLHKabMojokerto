  ...
  >
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav mx-auto bg-light rounded pe-4 py-3 py-lg-0">
        ...
        <a href="penaatanakun.php" class="nav-item nav-link active">Pengaturan Akun</a>
      ...
      <div class="container">
        <div class="text-center mx-auto" style="max-width: 1000px">
          <h1 class="display-6 mb-3">
            Edit Akun <?php echo $lp->nama_bidang ?><br>DLH Kab Mojokerto
          </h1>
        </div>
                    ...
                    if (isset($_POST['penaatan'])) {
                      ...
                      if ($pass2penaatan != $pass1penaatan) {
                        ...
                        if ($updatepasspenaatan) {
                          ...
                          echo '<script>alert("Update Profil Bidang Penaatan Berhasil!")</script>';
                          echo '<script>window.location="penaatanakun.php"</script>';
                        }else{
