<?php 
  ...
  include 'db.php';
	...
	if($_SESSION['id_admin']!='1'&'10'){
		echo '<script>window.location="login.php"</script>';
    echo "<div class='alert'>Gagal!</div>";
	}

    $idbtl = mysqli_query($koneksi, "SELECT * FROM dataset WHERE id = '".$_GET['id']."'");
    if(mysqli_num_rows($idbtl) == 0){
        echo '<script>window.location="btladmin.php"</script>';
      }

    $idtata = mysqli_fetch_object($idbtl);
        ...
        <div class="container mt-3 text-left p-5">       
                    ...
                    <div class="col-lg-9 wow fadeIn" data-wow-delay="0.1s">
                      <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row g-3">
                          <div class="col-md-12">
                            <div class="form-floating">
                              <input
                                ...
                                value="<?php echo $idtata->nama_dataset ?>"
                                required
                              />
                          ...
                          <div class="col-md-12">
                            <div class="form-floating">
                              <input
                                ...
                                value="<?php echo $idtata->format_dataset ?>"
                                required
                              />
                          ...
                          <div class="col-12">
                                <input type="submit" name="editdataset" value="Edit Dataset Tata Lingkungan" class="btn btn-primary py-2 px-4">
                          </div>
                        </div>
                      </form>
                    </div>
          ...
          if (isset($_POST['editdataset'])){
            ...
            $update = mysqli_query($koneksi, "UPDATE dataset SET
              ...
              if ($update) {
                echo '<script>alert("Edit Dataset Tata Lingkungan Berhasil!")</script>';
                echo '<script>window.location="btladmin.php"</script>';
              }else{
