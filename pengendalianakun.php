  ...
  >
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav mx-auto bg-light rounded pe-4 py-3 py-lg-0">
        ...
        <a href="pengendalianakun.php" class="nav-item nav-link active">Pengaturan Akun</a>
      ...
      <div class="container">
        <div class="text-center mx-auto" style="max-width: 1000px">
          <h1 class="display-6 mb-3">
            Ganti Akun Admin <?php echo $peng->nama_bidang ?><br>DLH Kab Mojokerto
          </h1>
        </div>
                    ...
                    if (isset($_POST['pengendalian'])) {
                      ...
                      if ($pass2pengendalian != $pass1pengendalian) {
                        ...
                        if ($updatepasspengendalian) {
                          ...
                          echo '<script>window.location="pengendalianakun.php"</script>';
                        }else{
