              ...
              <div class="d-flex align-items-center ms-n5 mb-4">
                ...
                >
                  <img
                    class="img-fluid"
                    width="150px"
                    src="img/<?php echo $lp->nama_files ?>"
                    alt=""
                  />
                </div>
                <h4 class="mb-0"><?php echo $lp->nama_bidang ?></h4>
              </div>
              <p class="mb-4">
              <?php 
            ...
            <div class="service-item rounded h-100 p-5">
              <div class="d-flex align-items-center ms-n5 mb-4">
                ...
                >
                  <img
                    class="img-fluid"
                    src="img/<?php echo $lpe->nama_files ?>"
                    alt=""
                  />
                </div>
            ...
            <div class="service-item rounded h-100 p-5">
              <div class="d-flex align-items-center ms-n5 mb-4">
                ...
                >
                  <img
                    class="img-fluid"
                    src="img/<?php echo $lsa->nama_files ?>"
                    alt=""
                  />
                </div>
                <h4 class="mb-0"><?php echo $lsa->nama_bidang ?></h4>
              </div>
              <p class="mb-4">
              <?php 
              while($datapengel=mysqli_fetch_array($datapengelolaan)){
               
                      echo $datapengel['nama_dataset'];
                      echo ", ";
            ...
            <div class="service-item rounded h-100 p-5">
              <div class="d-flex align-items-center ms-n5 mb-4">
                ...
                >
                  <img
                    class="img-fluid"
                    src="img/<?php echo $ll->nama_files ?>"
                    alt=""
                  />
                </div>
                <h4 class="mb-0"><?php echo $ll->nama_bidang ?></h4>
              </div>
              <p class="mb-4">
              <?php 
