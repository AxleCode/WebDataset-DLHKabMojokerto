  ...
  >
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav mx-auto bg-light rounded pe-4 py-3 py-lg-0">
        ...
        <a href="logolab.php" class="nav-item nav-link active">Pengaturan Logo</a>
      ...
      <div class="container">
        <div class="text-center mx-auto" style="max-width: 1000px">
          <h1 class="display-6 mb-3">
            Edit Logo UPDT Laboratorium<br>DLH Kab Mojokerto
          </h1>
        </div>
          ...
          if (isset($_POST['submitlogol'])){
              ...
              if ($filename != '') {
                ...
                if (!in_array($type2, $tipe_diizinkan)) {
                  ...
                  echo '<script>window.location="logolab.php"</script>';
