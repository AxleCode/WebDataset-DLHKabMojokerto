        ...
        <div class="container mt-3 text-left p-5 pt-1">       
                    ...
                    <div class="col-lg-9 wow fadeIn" data-wow-delay="0.1s">
                      <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row g-3">
                          ...
                          <div class="col-12">
                                <input type="submit" name="editdataset" value="Edit Dataset Sekretariat" class="btn btn-primary py-2 px-4">
                          </div>
                        </div>
                      </form>
                    </div>
          ...
          if (isset($_POST['editdataset'])){
            ...
            $update = mysqli_query($koneksi, "UPDATE dataset SET
              ...
              if ($update) {
                echo '<script>alert("Edit Dataset Sekretariat Berhasil!")</script>';
                echo '<script>window.location="sekretariatadmin.php"</script>';
              }else{
