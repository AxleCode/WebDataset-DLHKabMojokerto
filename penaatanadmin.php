    ...
    >
      <div class="row gx-0 align-items-center">
        ...
        <div class="col-lg-5 px-5 text-end">
            ...
            else if($_SESSION['id_admin']=='4'){
              echo "Admin Penaatan DLH";
            }
             ?>&nbsp;</a></small>
  ...
  >
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav mx-auto bg-light rounded pe-4 py-3 py-lg-0">
        ...
        <a href="penaatanadmin.php" class="nav-item nav-link active">Pengaturan Data</a>
      ...
      <div class="container">
        <div class="text-center mx-auto" style="max-width: 1000px">
          <h1 class="display-6 mb-3">
            Dataset Bidang Penaatan<br>DLH Kab Mojokerto
          </h1>
        </div>

        <div class="container mt-3 text-left p-5">
            <a href="penaatantambahdata.php"><button class="btn btn-success py-2 px-4 " type="submit">
                        ...
                        while($data=mysqli_fetch_array($datasekretariat)){
                          ...
                          <tr>
                            ...
                            <td class="text-center"> <a href="<?php echo $data['linkedit'] ?>" target="_blank"><img src="img/google-docs.png" alt="Dataset" width="20px" ></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                     <a href="editpenaatan.php?id=<?php echo $data['id'] ?>" ><img src="img/edit.png" alt="Dataset" width="20px" ></a>&nbsp;&nbsp;&nbsp;
                                                     <a href="hapusdataset.php?iddatasetpenaatan=<?php echo $data['id'] ?>" onclick="return confirm('Yakin Ingin Hapus?')">
