...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Pengendalian - Dinas Lingkungan Hidup Kab Mojokerto</title>
  ...
  >
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav mx-auto bg-light rounded pe-4 py-3 py-lg-0">
        ...
        <a href="pengendalianadmin.php" class="nav-item nav-link active">Pengaturan Data</a>
    ...
    <div class="container-xxl py-5">
      <div class="container">
        ...
        <div class="container mt-3 text-left p-5">
            <a href="pengendaliantambahdata.php"><button class="btn btn-success py-2 px-4 " type="submit">
                        ...
                        while($data=mysqli_fetch_array($datasekretariat)){
                          ...
                          <tr>
                            ...
                            <td class="text-center"> <a href="<?php echo $data['linkedit'] ?>" target="_blank"><img src="img/google-docs.png" alt="Dataset" width="20px" ></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                     <a href="editpengendalian.php?id=<?php echo $data['id'] ?>" ><img src="img/edit.png" alt="Dataset" width="20px" ></a>&nbsp;&nbsp;&nbsp;
                                                     <a href="hapusdataset.php?iddatasetpengendalian=<?php echo $data['id'] ?>" onclick="return confirm('Yakin Ingin Hapus?')">
